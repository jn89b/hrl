...
import numpy as np
from grid_env import DefensivePolicyEnv  # Assuming your environment is defined in grid_env.py
...
ppo_config = (
    ...
    .environment(env=DefensivePolicyEnv, env_config={})
    .env_runners(
        num_env_runners=1,
...
cwd = os.getcwd()
storage_path = os.path.join(cwd, "ray_results", "DefensivePolicyEnv")
exp_name = "PPO_DefensivePolicyEnv"
